...
function SignUp() {
  let navigate=useNavigate();
    ...
    const [credentials, setCredentials] = useState({name:"",email:"",password:"",location:"",img:""})
    const handleSubmit=async(e)=>{
        if(credentials.name && credentials.email && credentials.password && credentials.location){
          e.preventDefault();
        const response= await fetch("https://farmeasy-zwa7.onrender.com/api/createuser",{
            method:"POST",
            headers:{
    ...
    <div className="row d-flex justify-content-center align-items-center h-100">
      <div className="col-lg-12 col-xl-11">
        <div className="card text-black" style={{border:"none"}}>
          <div className="card-body p-md-5" style={{backgroundColor:"#fcf8e8"}}>
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form onSubmit={handleSubmit} className="mx-1 mx-md-4">
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    <i className="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div className="form-outline flex-fill mb-0">
                      <input type="text" className="form-control"  onChange={(e)=>setCredentials({...credentials,img:e.target.value})} value={credentials.img}/>
                      <label className="form-label"for="form3Example1c">Your Image</label>
                    </div>
                  </div>
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src={process.env.PUBLIC_URL + "/20230226_184157_0000.png"}
